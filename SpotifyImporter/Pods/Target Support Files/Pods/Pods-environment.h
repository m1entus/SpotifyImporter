...
// DJProgressHUD_OSX
#define COCOAPODS_POD_AVAILABLE_DJProgressHUD_OSX
#define COCOAPODS_VERSION_MAJOR_DJProgressHUD_OSX 0
#define COCOAPODS_VERSION_MINOR_DJProgressHUD_OSX 0
#define COCOAPODS_VERSION_PATCH_DJProgressHUD_OSX 1
